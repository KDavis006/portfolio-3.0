    ...
    <div className='bg-black h-full w-screen'>
      ...
      <div className='flex justify-center items-center h-screen w-screen'>
        <div className='text-center'>
          ...
          <h2 className='mb-4 text-7xl leading-none tracking-tight text-gray-900 md:text-7xl dark:text-white'>
      ...
      <div className='h-screen items-center justify-center flex'>
        <div
          ...
          data-delay='1500'
          className='flex flex-col md:flex-row justify-evenly h-2/3 w-4/5 bg-black bg-opacity-60'
        >
          <Image
            data-aos='fade-right'
            data-aos-duration='1000'
          ...
          >
            ...
            <div className='w-full flex justify-center'>
              <h4 className='text-center w-4/6 text-2xl md:text-xl sm:text-lg'>
      ...
      <div className='h-screen items-center justify-center flex'>
        ...
        >
          <main className='bg-gradient-to-r from-[#c8dba] to-[#a49d9b] w-full min-h-screen mx-auto grid'>
            <Slider />
          </main>
        </div>
      </div>
