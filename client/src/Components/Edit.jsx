...
export default function Edit(){
    ...
    async function fetchFunction(e){
        e.preventDefault();
        const update = {...form}
        const getData = await fetch("http://localhost:3000/docs", {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            credentials: 'include',
        })
        //const postData = await fetch("http://localhost:3000/docs", {
        //    method: "POST",
        //    headers: { "Content-Type": "application/json" },
        //    credentials: 'include',
        //    body: JSON.stringify(update)
        //})
        //const putData = await fetch("http://localhost:3000/docs", {
        //    method: "PUT",
        //    headers: { "Content-Type": "application/json" },
        //    credentials: 'include',
        //    body: JSON.stringify(update)
